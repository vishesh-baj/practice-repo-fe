...
const Navbar = () => {
  return (
    <header className="w-full flex">
      <nav className="w-full h-[8vh] md:px-0 px-10  flex justify-between md:justify-end items-center bg-white drop-shadow-lg">
        {/* active tab heading */}
        <AiOutlineMenu size={20} className=" md:hidden" />
